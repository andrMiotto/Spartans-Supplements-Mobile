...
fun CheckoutScreenFunction(viewModel: ProdutoViewModel, navController: NavHostController) {
    ...
    Column(
        ...
        Text("Seus produtos", fontWeight = FontWeight.Bold)
        ...
        Text("Método de pagamento", fontWeight = FontWeight.Bold)

        Row(verticalAlignment = Alignment.CenterVertically) {
            RadioButton(
                selected = metodoPagamento == "Cartão",
                onClick = { metodoPagamento = "Cartão" }
            )
            Text("Cartão")
        }
